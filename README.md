...
> 📥 **[下载 PDF / EPUB](#-电子书)**（推荐）— 推荐使用 PDF / EPUB 离线阅读，排版最佳；也可[在线阅读](https://bojieli.github.io/ai-agent-book/)（支持章节折叠、全文搜索，每次推送自动更新）。
...
| 📚 **10 章** 正文，从基础到生产 | 📂 **109 个** 配套实验（含本地项目与外部复现轨道） |
| :---: | :---: |
...
>
> 🌐 也可[在线阅读](https://bojieli.github.io/ai-agent-book/) — 支持章节折叠、全文搜索、配套实验直达，每次 main 分支推送后自动重新构建。
